...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_PRICE_ID_SOLO_PLAN: z.string(),
    STRIPE_PRICE_ID_FREELANCE_PLAN: z.string(),
  ...
  runtimeEnv: {
    ...
    STRIPE_PRICE_ID_SOLO_PLAN: process.env.STRIPE_PRICE_ID_SOLO_PLAN,
    STRIPE_PRICE_ID_FREELANCE_PLAN: process.env.STRIPE_PRICE_ID_FREELANCE_PLAN,
